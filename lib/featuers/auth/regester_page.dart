...
class _RegesterPageState extends State<RegesterPage>
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      if (mounted) {
        _showSnackBar('تم إنشاء الحساب بنجاح! مرحباً بك');
        await Future.delayed(const Duration(seconds: 1));
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (_) => const LoginScreenLight()),
        );
      }
    } catch (e) {
      if (mounted) {
        _showSnackBar('فشل إنشاء الحساب: ${e.toString()}', isError: true);
      }
    } finally {
      if (mounted) {
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Glass Card with Register Form
                        _buildGlassCard(context, theme, primaryColor),

                        const SizedBox(height: 24),

                        // Login Link
                        _buildLoginLink(theme, primaryColor),
    ...
    return Stack(
      children: [
        Positioned(
          top: -80,
          left: -80,
          child: _buildCircle(220, Colors.purple.withOpacity(0.1)),
        ),
        Positioned(
          bottom: -60,
          right: -60,
          child: _buildCircle(200, Colors.blue.withOpacity(0.1)),
        ),
        Positioned(
          top: size.height * 0.4,
          right: -40,
          child: _buildCircle(160, Colors.cyan.withOpacity(0.1)),
        ),
      ],
    );
  }
  ...
  // Login Link
  Widget _buildLoginLink(ThemeData theme, Color primaryColor) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Text(
